...
export default function Register() {
    ...
    const submit = (e) => {
        ...
        // This will automatically handle headers, responses, and redirects
        post(route('register'));
    };
            ...
            <form onSubmit={submit}>
                <div>
                    ...
                    <TextInput
                        id="name"
                        name="name"
                        value={data.name} // Use data from useForm
                ...
                <div className="mt-4">
                    ...
                    <TextInput
                        ...
                        value={data.password_confirmation} // Use data from useForm
                        className="mt-1 block w-full"
                        autoComplete="new-password"
                        onChange={(e) => setData('password_confirmation', e.target.value)} // Use setData
                        required
                    />
